...
var KTWidgets = function () {
    // Private properties
  var _handleFormPasswordRefresh = function () {
    var form = KTUtil.getById('kt_login_passwordrefresf_form');
    var formSubmitUrl = KTUtil.attr(form, 'action');
    var formSubmitButton = KTUtil.getById('kt_login_passwordrefresh_form_submit_button');
        ...
        form,
        {
          fields: {
            EMail: {
              validators: {
                notEmpty: {
                  message: 'E-mail Alaný Zorunludur!'
                },
                emailAddress: {
            ...
            Sifre: {
              validators: {
                notEmpty: {
                  message: 'Sifre Alaný Zorunludur!'
                }
              }
            },
            YeniSifre: {
              validators: {
                notEmpty: {
                  message: 'Yeni Sifre Alaný Zorunludur!'
                }
              }
            },
            YeniSifreTekrar: {
              validators: {
                notEmpty: {
                  message: 'Yeni Sifre Tekrar Alaný Zorunludur!'
                }
              }
            }
          },
